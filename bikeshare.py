...
def user_stats(df):
    ...
    #ViewRawData = input('Would you like to see first 5 rows of data? Please enter yes or no:').lower()
    
    #TimesRawData= 0
    
    #while ViewRawData == "yes":
        #print(df.iloc[TimesRawData:TimesRawData+5])
        #ViewRawData = input('Would you like to see next 5 rows of data? Please enter yes or no:').lower()
        #TimesRawData+=5     
        #break
